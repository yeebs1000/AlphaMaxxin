...
# 32 Prompts across 5 Layers
# Version 3.0

## v3.0 — WHAT CHANGED
  - HEADLINE FEATURE: All paid data/LLM APIs are now live and linked —
    Claude, Gemini, OpenAI, Finnhub, Alpha Vantage, and moomoo OpenD
    (real-time quotes, positions, order book, dividends, analyst
    consensus, industry classification). No simulated or placeholder
    data sources remain in the pipeline.
  - Master Orchestrator (Prompt 0) and Investment Recommendation Agent
    (Prompt 29) rewritten for institutional concision: retail-narrative
    prose, jargon-explaining, and analogy-driven writing replaced with
    bullet/table-first output and hard per-section word caps. Same
    analytical content, far fewer tokens — reports complete instead of
    truncating mid-section.
  - Removed the fabricated "agent service status" narrative (e.g.
    invented 503 error counts). Missing sub-agent data is now reported
    as a single factual coverage line — never a speculated cause.
  - Sub-agent fan-out is now concurrency-limited with automatic retry,
    reducing the real provider rate-limit failures that caused missing
    sections in v2.4 runs.
...
LAYER 1    — DATA AGENTS (Prompts 1–16)
  01. US Macro Analyst
  ...
  16. Real-Time News Intelligence Agent

LAYER 2    — ANALYSIS AGENTS (Prompts 17–24)
  17. Fundamental Analysis Agent
  18. Technical Analysis Agent
  19. Sector Analyst Agent
  20. Social Sentiment Scanner
  21. Catalyst & Event Calendar Agent
  22. IPO & Primary Markets Agent
  23. Private Capital & Corporate Activity Agent
  24. Machine Learning Alpha Extractor

LAYER 3    — SYNTHESIS AGENTS (Prompts 25–28)
  25. Quantitative Signal Aggregator
  26. Backtester & Simulation Validator
  27. Risk Management Agent
  28. Portfolio Construction Agent

LAYER 4    — OUTPUT AGENTS (Prompts 29–32)
  29. Investment Recommendation Agent
  30. Execution & Trade Management Agent
  31. CFD Funding & Cost Optimizer
  32. High-Conviction Stock & Options Screener
```
...
Note: Prompt 16 (News Intelligence Agent) and Prompt 32 (Stock Screener)
are pipeline/output agents — they do not carry direct aggregator weights.
The News Agent enriches all Layer 2 agents with parsed data; the Stock
Screener reads from the Aggregator output directly.
...
# PROMPT 16 — REAL-TIME NEWS INTELLIGENCE AGENT
...
# PROMPT 17 — FUNDAMENTAL ANALYSIS AGENT
...
# PROMPT 18 — TECHNICAL ANALYSIS AGENT
...
---
# PROMPT 19 — SECTOR ANALYST AGENT
...
# PROMPT 20 — SOCIAL SENTIMENT SCANNER
...
# PROMPT 21 — CATALYST & EVENT CALENDAR AGENT
...
---
# PROMPT 22 — IPO & PRIMARY MARKETS AGENT
...
# PROMPT 23 — PRIVATE CAPITAL & CORPORATE ACTIVITY AGENT
...
# PROMPT 24 — MACHINE LEARNING ALPHA EXTRACTOR
...
# PROMPT 25 — QUANTITATIVE SIGNAL AGGREGATOR
...
# PROMPT 26 — BACKTESTER & SIMULATION VALIDATOR
...
---
# PROMPT 27 — RISK MANAGEMENT AGENT
...
# PROMPT 28 — PORTFOLIO CONSTRUCTION AGENT
...
---
# PROMPT 29 — INVESTMENT RECOMMENDATION AGENT
...
# PROMPT 30 — EXECUTION & TRADE MANAGEMENT AGENT
...
# PROMPT 31 — CFD FUNDING & COST OPTIMIZER
...
v2.4 — Two New Agents Added
       Prompt 16: Real-Time News Intelligence Agent (Finnhub + AlphaVantage APIs)
       Prompt 32: High-Conviction Stock & Options Screener
       All existing Layer 2-4 prompts renumbered +1 to accommodate News Agent in Layer 1
       Total: 32 numbered prompts (1–32) + Prompt 0 Orchestrator = 33 items
